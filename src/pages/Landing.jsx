              ...
              <div className="mt-12 lg:mt-0 relative">
                ...
                <div className="relative bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-2xl p-6 shadow-2xl">
                  ...
                  <div className="flex justify-between items-center mb-6 border-b border-slate-200 dark:border-slate-800 pb-4">
                    ...
                    <span className="px-2 py-1 bg-green-500/20 text-green-600 dark:text-green-400 text-xs rounded">
                      Live Updates
                    </span>
                  </div>
                  <div className="space-y-4">
        ...
        <div className="py-24">
          <div className="max-w-5xl mx-auto px-4 text-center bg-linear-to-br from-emerald-800 to-slate-900 dark:from-emerald-900/50 dark:to-slate-900 border border-emerald-500/30 rounded-3xl p-12 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <Link
                to="/login"
                className="px-10 py-4 bg-white text-emerald-900 font-bold rounded-full hover:bg-emerald-50 transition-colors shadow-lg"
              >
                Get Started Free
              </Link>
            </div>
...
function MarketRateRow({ type, price, change, positive }) {
  return (
    <div className="flex justify-between items-center bg-slate-50 dark:bg-slate-800/50 p-3 rounded-lg border border-slate-100 dark:border-transparent">
      ...
      <div className="flex items-center gap-4">
        ...
        <span
          className={`text-xs px-1.5 py-0.5 rounded ${positive ? "bg-green-500/20 text-green-600 dark:text-green-400" : "bg-red-500/20 text-red-600 dark:text-red-400"}`}
        >
          {change}
        </span>
      </div>
